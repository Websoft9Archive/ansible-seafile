...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 [Seafile](https://www.seafile.com/home/) 自动化安装程序，开发语言是 Ansible。使用本项目，只需要用户在 Linux 上运行一条命令，即可自动化安装 Seafile，并预配置必要项，让原本复杂的安装和与配置过程变得没有任何技术门槛。
...
更多请见： [官方 System requirement](https://www.seafile.com/download/)。

## 组件

包含的核心组件为：Seafile on Docker, ONLYOFFICE Document Server on Docker, MySQL, phpMyAdmin on Docker, Docker  
...
```
wget -N https://ghproxy.com/https://raw.githubusercontent.com/Websoft9/ansible-linux/main/scripts/install.sh; bash install.sh -r seafile
```
