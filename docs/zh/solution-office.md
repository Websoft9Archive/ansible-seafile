...
1. 在云控制台安全组中，检查 **TCP:9002** 和 **TCP:9003** 端口是否开启
...
1. 使用 SFTP 连接服务器，编辑 Seafile 配置文件 **seahub_settings.py**
2. 插入下面的模板
   ```
   # Enable Only Office
   ENABLE_ONLYOFFICE = True
   VERIFY_ONLYOFFICE_CERTIFICATE = False
   ONLYOFFICE_APIJS_URL = 'http://119.8.39.175:9003/web-apps/apps/api/documents/api.js'
